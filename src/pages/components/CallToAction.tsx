        ...
        <>
            ...
            <div className=" mb-4"></div>
                ...
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">
                    ...
                    <div className="mb-6">
                        <label className="block text-white-700 text-xl font-extrabold mb-3 text-center" htmlFor="Full name">
                            Nombre Completo
                        </label>
                    ...
                    <div className="mb-6">
                        <label className="block text-white-700 text-xl font-extrabold mb-2 text-center" htmlFor="Email">
                            Correo Electronico
                        </label>
                    ...
                    <div className="mb-6">
                        <label className="block text-white-700 text-xl font-extrabold mb-2 text-center" htmlFor="telephone">
                            Numero telefonico
                        </label>
                        <input className="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-center text-gray-900 font-bold mb-3 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Correo Electronico"/>
